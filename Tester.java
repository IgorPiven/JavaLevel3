...
public class Tester {
    ...
    public static void start(Class intClass) throws InvocationTargetException, IllegalAccessException {
        ...
        Object obj = null;
        try {
            obj = intClass.newInstance();
        } catch (InstantiationException e) {
            e.printStackTrace();
        }

        for (Method m : intClass.getDeclaredMethods()) {
